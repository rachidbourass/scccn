...
public class IdentityUtils {
	...
	public List<Identity>  getNullAttributeIdentities(String attribName, String attribValue) throws GeneralException{
	    QueryOptions qo = new QueryOptions();
	...
	public boolean runSingleAggregation(String nativeIdentity, String appName) throws GeneralException {
		  ...
		  Application appObject = context.getObjectByName(Application.class, applicationName);
		      ...
		      try{
		        rObj = (ResourceObject) ((Connector) appConnector).getObject("account", accountName, null);
