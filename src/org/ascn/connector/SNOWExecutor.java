...
/**
 * This class is not being used currently. We need to figure out why the ServiceDesk application does not invoke methods in this class.
 */
...
public ProvisioningPlan sdExecute(ProvisioningPlan plan) {
	...
	try {
		...
		plan = snh.addAssignmentGroupInPlan(newPlan);
	} catch (Exception e) {
